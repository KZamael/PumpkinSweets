...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public void init(AssetManager assetManager){
        ...
        assetManager.load("android/assets/sounds/landing.wav", Sound.class);
        ...
        initializeMovableAssets(atlas);
    }

    private void initializeMovableAssets(TextureAtlas atlas) {
    ...
    public class AssetFonts {
        ...
        public AssetFonts() {
            ...
            System.out.println("Its: " + Gdx.files.getLocalStoragePath());
    ...
    public class AssetSounds {
        ...
        public AssetSounds(AssetManager am) {
            ...
            landing = am.get("android/assets/sounds/landing.wav",Sound.class);
