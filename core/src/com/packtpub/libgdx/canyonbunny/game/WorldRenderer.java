...
public class WorldRenderer implements Disposable {
  ...
  private void init(){
    ...
    orthographicCamera = new OrthographicCamera(Constants.VIEWPORT_WIDTH,
  ...
  private void renderWorld (SpriteBatch batch) {
    ...
    if(DEBUG_DRAW_BOX2D_WORLD) {
      box2DDebugRenderer.render(worldController.b2world, orthographicCamera.combined);
    }
  }
  ...
  public void resize (int width, int height) {
    orthographicCamera.viewportWidth = (Constants.VIEWPORT_HEIGHT / height) *
            width;
    orthographicCamera.update();
