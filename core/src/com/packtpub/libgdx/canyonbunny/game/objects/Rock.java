...
public class Rock extends AbstractGameObject {
    ...
    public void render(SpriteBatch batch) {
        ...
        /* Draw middle, by iterating over the given length and use the "relative X" together with the dimensional position to
           create a bunch of rocks next to each other. */
        relX = 0;
        reg = regMiddle;
        ...
        // Draw right edge which is the left edge, but flipped
        reg = regEdge;
        batch.draw(reg.getTexture(),position.x + relX, position.y +
