...
public class ScreenTransitionsSlice implements ScreenTransition {
  public static final int UP = 1;
  public static final int DOWN = 2;
  public static final int UP_DOWN = 3;

  private static final ScreenTransitionsSlice instance = new ScreenTransitionsSlice();
  ...
  public static ScreenTransitionsSlice init(float duration, int direction, int numSlices, Interpolation easing) {
  ...
  public void render(SpriteBatch batch, Texture currScreen, Texture nextScreen, float alpha) {
    ...
    for(int i = 0; i < sliceIndex.size; i++) {
      ...
      x = i * sliceWidth;
      // vertical displace using randomized
